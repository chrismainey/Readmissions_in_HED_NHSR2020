...
___Adjust all to the expected average risks for predictors___

--

+ Commonly use a regression model to estimate effects of predictors.

+ Our model can then be used to predict the risk of event for each patient.

--

+ We can compare out predicted risks to events we are observing as a __Relative risk ratio__:
...
<br>
___Readmission to any acute provider within 30-days of discharge from another. Indexed to discharge from the first organisation.___
